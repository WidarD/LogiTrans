...
public class tractor_unit_database_handler {
    ...
    public static ObservableList<tractor_unit_model> getAllTractorUnit() throws SQLException {
        ...
        ObservableList<tractor_unit_model> tractorList = FXCollections.observableArrayList();
        while (rst.next()) {
