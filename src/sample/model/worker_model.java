...
public class worker_model {
    ...
    public String sanitary_book;
    public String driver_card;
    public Boolean OHS;
    public int id_semi_trailer;
    public int id_tractor_unit;

    public worker_model(int idWorker, String name, String surname, String login, String password, String ID_number, String phone_number, String driving_license, String sanitary_book, String driver_card, Boolean OHS, Integer id_semi_trailer, Integer id_tractor_unit){
    ...
    public String getSanitary_book() {
        return sanitary_book;
    }

    public void setSanitary_book(String sanitary_book) {
        this.sanitary_book = sanitary_book;
    }
